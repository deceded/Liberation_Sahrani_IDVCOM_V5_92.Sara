...
KP_liberation_air_vehicle_building = "US_WarfareBUAVterminal_Base_EP1";				// The building defined to unlock FOB air vehicle functionality.																		Default is "Land_Radar_Small_F".
...
KP_liberation_plane_slot_building = "Windsock_01_F";				// The hangar used to increase the GLOBAL fixed-wing cap.																				Default is "Land_TentHangar_V1_F".
